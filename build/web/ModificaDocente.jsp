        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Actualizar Docente</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="ListaDocente.jsp">Lista de Docente</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <% String ca = request.getParameter("codi");%>
                                 <% Modelo.DOCENTE a = Modelo.DOCENTE.getIdDocente(ca);%>
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaDocente" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIddodocente()); %>" readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                     <input type="text" class="form-control form-control-danger" name="dire" value="<% out.println(a.getDireccion()); %>">
                                                  </div>
                                            </div>
                                            <!--/span-->
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="fec" value="<% out.println(a.getFecha_n()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="tel" class="form-control" value="<% out.println(a.getTelefono_fijo()); %>" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="email" class="form-control" name="cor" value="<% out.println(a.getCorreo()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="con" class="form-control"value="<% out.println(a.getContra()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="titu" value="<% out.println(a.getTitulo()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
