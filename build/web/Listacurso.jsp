 <%-- 
    Document   : Listacurso
    Created on : 22-dic-2019, 18:07:35
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Cursos</h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Cursos..</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">ESTADO</th>
                                         ...
                                         <tbody>
                                             <% for(Modelo.CURSO a : CURSO.ListaCargo()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesCurso.jsp?cod=<%= a.getIdcurso()%>"><%= a.getNombrecurso()%></a></td>
