<%-- 
    Document   : ListaGradoDocente
    Created on : 24-dic-2019, 13:24:55
    Author     : Kevin Damian
--%>
<%@page import="java.sql.*"%>
<%@page import="javax.swing.table.DefaultTableModel"%>
<%@page import="Modelo.Conexion"%>
<%@page import="Modelo.CURSO_DOCENTE"%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Listado</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Datos</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Lista de Datos</h4>
                                <form action="ListaGradoDocente.jsp" name="form1" class="table table-responsive">
                                    <div class="form-group col-md-12">
                                                ...
                                                <label class="control-label text-right col-md-3">GRADO </label>
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="grado" class="form-control"required>
                                                            ...
                                                            <option  > <%=cat.getGradoseccion() %></option>
                                                            <% }%>
                                                        </select>
                                        ...
                                        <div class="form-row mt-2">
                                            <input type="submit" value="Buscar" class="btn btn-danger" href="ListaGradoDocente.jsp">
                                        </div>
                                    </div>
                                </form>
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">COD CURSO</th>
                                          <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">CURSO</th>
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">DOCENTE</th>
                                          <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">COD DOCENTE</th>
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">COD GRADO</th>
                                    ...
                                    <tbody>
                                        <%
                                            CURSO_DOCENTE v = new CURSO_DOCENTE();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();
                                            
                                    String ven=request.getParameter("grado");
                                            t = v.ListaGrado(ven ,cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                            <td class="title"><%= t.getValueAt(i, 0) %></td>
                                             <td class="title"><%= t.getValueAt(i, 1) %></td>
                                             <td class="title"><%= t.getValueAt(i, 2) %></td>
                                             <td class="title"><%= t.getValueAt(i, 3) %></td>
                                             <td class="title"><%= t.getValueAt(i, 4) %></td>
                                             <td class="title"><%= t.getValueAt(i, 5) %></td>
                                             <td class="title"><%= t.getValueAt(i, 6) %></td>
                                        </tr>  
                                         <% } %>                                           
                                    </tbody>
