<%-- 
    Document   : DetallesCursoDocente
    Created on : 22-dic-2019, 22:52:01
    Author     : Kevin Damian
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detalle Cursos Docente</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                            <li class="breadcrumb-item"><a href="Listacursosdocente.jsp">Cursos Docente</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% Modelo.CURSO_DOCENTE a = Modelo.CURSO_DOCENTE.getIdCursoDocente(ca);%>
                                    ...
                                    <form class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">COD CURSO</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getIdcurso()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getDescurso()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">COD DOCENTE</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getIddocente()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">DOCENTE:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getDesdocente()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">COD GRADO:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getIdgrado()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarCursoDocente?codi=<%= a.getIdcursodocente()%> "> Eliminar</a></button>
