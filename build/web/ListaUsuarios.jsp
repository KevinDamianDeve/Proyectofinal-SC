<%-- 
    ...
    Created on : 11-dic-2019, 6:28:35
    Author     : Jeampier
--%>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Usuarios Activos Actualmente.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <!--<tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.USUARIO a:USUARIO.ListaUsuario()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesUsuario.jsp?cod=<%= a.getIdusuario()%>"><%= a.getNombres()%> <%= a.getApellidos()%></a></td>
                                                 <td><%= a.getDni()%></td>
                                                 <td><%= a.getFnacimiento()%></td>
                                                 <td><%= a.getGenero()%></td>
                                                 <td><%= a.getCelular()%></td>
