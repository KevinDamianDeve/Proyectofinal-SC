<%-- 
    Document   : Listatrimestre
    Created on : 20-dic-2019, 14:35:35
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Trimestres</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Trimestres</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Lista de Trimestres</h4>
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Trimestres  .</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <!--<tbody>
                                        <%
                                            TRIMESTRE v = new TRIMESTRE();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaTri(cn.conectar());
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.TRIMESTRE a : TRIMESTRE.ListaTrimestre()) { %>
                                             <tr>
                                                 <td><%= a.getIdtrimestre()%></td>
                                                 <td class="title"><a class="link" href="DetallesTrimestre.jsp?cod=<%= a.getIdtrimestre()%>"><%= a.getDes()%></a></td>
