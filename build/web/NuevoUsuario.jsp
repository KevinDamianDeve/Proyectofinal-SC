                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletRegistrarUsuario"  enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="numer" class="form-control" name="telefono" placeholder="7654309876654">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control custom-select" required="" name="esta">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="cargo" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.CARGO cat : Modelo.CARGO.ListaCargo()) {%>

                                                            <option value="<%=cat.getIdcargo()%>" > <%=cat.getDescripcion()%></option>
                                                            <% }%>
                                                        </select>
