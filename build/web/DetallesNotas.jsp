<%-- 
    Document   : DetallesGrado
    Created on : 11-dic-2019, 4:57:57
    Author     : Jeampier
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detalle Notas</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                            <li class="breadcrumb-item"><a href="Listanotas.jsp">Lista de Notas</a></li>
                            <li class="breadcrumb-item active">Detalle Notas</li>
                        </ol>
                    </div>
                    <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% Modelo.NOTAS a = Modelo.NOTAS.getIdNotasListado(ca);%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getNomalu()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getNomcurso()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                        ...
                                                        <div class="row" >
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    <label class="control-label text-right col-md-3">TRIMESTRE:</label>
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static"> <% out.println(a.getNomtrimestre());%> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    <label class="control-label text-right col-md-3">NOTA:</label>
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static"> <% out.println(a.getNota());%> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <p class="form-control-static"> <% out.println(a.getObservacion());%> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaNotas.jsp?codi=<%= a.getIdnotas()%>"> Editar</a></button>
