        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Docentes</h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Docentes.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">Direccion</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Celular</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Correo</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                            DOCENTE v = new DOCENTE();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaDocentes(cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                            <%= t.getValueAt(i, 0) %></a></td>
                                         ...
                                         <tbody>
                                             <% for(Modelo.DOCENTE a:DOCENTE.ListaDocente()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesDocente.jsp?cod=<%= a.getIddodocente()%>"><%= a.getNombres()%> <%= a.getApellidos()%></a></td>
                                                 <td><%= a.getDni()%></td>
                                                 <td><%= a.getFecha_n()%></td>
