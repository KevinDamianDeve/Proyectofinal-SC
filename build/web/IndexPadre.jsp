        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Estudiantes  </h3>
                    <h4 class="text-themecolor"> Apoderado: <%=car.getNombre()%> <%=car.getApellidos()%> </h4>
                </div>
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                       <h4 class="card-subtitle">Seleccione un estudiante para ver sus notas.</h4>
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            t = v.DocentesAlumno(car.getIdApoderado(), cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                
                                        <tr>
                                            <td class="title"><a class="link" ><%= t.getValueAt(i, 0)%></a></td>
                                            <td class="title"><a class="link"  href="ListaNotasParaPadre.jsp?codal=<%= t.getValueAt(i, 0)%>&nom=<%= t.getValueAt(i, 1)%> "    ><%= t.getValueAt(i, 1)%></a></td>
