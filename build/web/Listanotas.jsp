                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra las Notas de Todos Los Alumnos Activos Actualmente.</h6>
                                <tr>
                                    <td colspan="2">
                                        <h3><font color="red">
                                ...
                                <form action="Listanotas.jsp" name="form1" class="table table-responsive">
                                    <div class="form-group col-md-12">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <label class="control-label text-right col-md-3">ALUMNO </label>
                                                    <div class="col-md-6">


                                                        <select  name="alumno" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.ALUMNO cat : Modelo.ALUMNO.ListaAlumnoEstudiando()) {%>

                                                            <option  > <%=cat.getNom()+ " " + cat.getApellidos()%></option>
                                                            <% }%>
                                                        </select>
                                                        ...
                                                        <div class="form-row mt-4">
                                                            <input type="submit" value="Buscar" class="btn btn-danger" href="Listanotas.jsp">
                                                        </div>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">CURSO</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">GRADO</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">TRIMESTRE</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">NOTA</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">OBSERVACION</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            ...
                                            DefaultTableModel t = new DefaultTableModel();                                                                                String ven=request.getParameter("grado");
                                            String ven2=request.getParameter("alumno");
                                            t = v.ListaNotasAlumno( ven2, cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                            <td><%= t.getValueAt(i, 0) %></td>
                                            <td class="title"><a class="link" href="DetallesNotas.jsp?cod=<%= t.getValueAt(i, 0) %>"><%= t.getValueAt(i, 1) %></a></td>
