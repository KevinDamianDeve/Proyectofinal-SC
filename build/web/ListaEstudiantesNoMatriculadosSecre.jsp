<%-- 
    Document   : ListaEstudiantesNoMatriculadosSecre
    Created on : 06-ene-2020, 21:53:36
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Alumnos No Matriculados</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="IndexSecre.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Alumnos No Matriculados</li>
                    </ol>
                </div>
                <div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Alumnos no matriculados.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Nombre y Apellidos</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">Fecha Nacimiento</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">DNI</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">Sexo</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Procedencia</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Direccion</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                            ...
                                            t = v.ListaAlumnosNoMatriculados(cn.conectar());
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.ALUMNO a:ALUMNO.ListaAlumnoNoMatriculados()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesAlumnoSecre.jsp?cod=<%= a.getIdalumno()%>"><%= a.getNom()%> <%= a.getApellidos()%></a></td>
