<%-- 
    Document   : DetallesTrimestre
    Created on : 20-dic-2019, 14:40:54
    Author     : Kevin Damian
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detalle Trimestre</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                            <li class="breadcrumb-item"><a href="Listatrimestre.jsp">Lista de Trimestre</a></li>
                            <li class="breadcrumb-item active">Detalle Trimestre</li>
                        </ol>
                    </div>
                    <div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">COD</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getIdtrimestre()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getDes()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaTrimestre.jsp?codi=<%= a.getIdtrimestre()%>"> Editar</a></button>
                                                            <button type="button"  class="btn btn-inverse" onclick="window.location.href='Listatrimestre.jsp'">Cancelar</button>
                                                            <button type="button" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarTrimestre?codi=<%= a.getIdtrimestre()%>"> Eliminar</a></button>
