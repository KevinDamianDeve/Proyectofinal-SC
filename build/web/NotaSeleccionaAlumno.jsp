<%-- 
    Document   : NotaSeleccionaAlumno
    Created on : 27-dic-2019, 18:20:40
    Author     : Kevin Damian
--%>
...
<html lang="en">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Selecciona Alumno</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Selecciona Alumno</li>
                    </ol>
                </div>
                <div>
    ...
    <% 
          int codgrado=Integer.parseInt(request.getParameter("cod"));
     ...
     %>
         <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
               ...
               <thead>
                    <tr>
                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">COD ALUMNO</th>
              ...
              <tbody>
                                        <%
                                            ...
                                            t = v.ListaSeleccionaAlumno(codgrado, cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                           <td><%= t.getValueAt(i, 0) %></td>
                                            <td class="title"><a class="link" href="NotaSeleccionaCurso.jsp?cod=<%= t.getValueAt(i, 0)%>&codgrado=<%=codgrado %>  "><%= t.getValueAt(i, 1) %></a></td>
