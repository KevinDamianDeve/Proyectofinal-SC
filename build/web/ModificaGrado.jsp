        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Actualizar Grado</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaGrado" >
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIdgrado()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Grado y Seccion: <span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="grado" value="<% out.println(a.getGradoseccion()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Capacidad: <span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-danger" name="capa" value="<% out.println(a.getMaxalumnos()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
