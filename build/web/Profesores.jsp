        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista Profesores y Cursos </h3>
                </div>
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona Profesor para ver mas</h4>
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            t = v.DocentesAlumno(car.getIdalumno(), cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="DetalleProfesorAlumno.jsp?codd=<%= t.getValueAt(i, 1)%> "><%= t.getValueAt(i, 2)%></a></td>
