<%-- 
    Document   : DetalleNotasProfe
    Created on : 08-ene-2020, 0:15:45
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Selecciona Curso</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="IndexProfe.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Selecciona Curso</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona curso para ingresar nota</h4>
    <% 
         int coda=Integer.parseInt(request.getParameter("codal"));
          int codgrado=Integer.parseInt(request.getParameter("codgra"));
         ...
         <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
               ...
               <thead>
                    <tr>
                       ...
                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">COD CURSO</th>
              ...
              <tbody>
                                        <%
                                            ...
                                            t = v.ListaCursosdeAlumnoProfesor(codgrado, coda, car.getIddodocente(), cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                            <td><%= t.getValueAt(i, 0) %></td>
                                           <td><%= t.getValueAt(i, 1) %></td>
                                       <td class="title"><a class="link" href="NuevaNotaProfesor.jsp?codalumno=<%= coda%>&codcurso=<%=t.getValueAt(i, 1) %>  "><%= t.getValueAt(i, 2) %></a></td>
