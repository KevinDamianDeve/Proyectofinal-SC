                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletRegistrarAlumno"  enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="dni" size="8" maxlength="8" class="form-control form-control-danger" placeholder="97647845" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
