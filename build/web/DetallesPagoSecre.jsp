<%-- 
    Document   : DetallesPagoSecre
    Created on : 06-ene-2020, 23:00:10
    Author     : Kevin Damian
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detalle PAGO</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="IndexSecre.jsp">Inicio</a></li>
                            <li class="breadcrumb-item"><a href="ListaPagosSecre.jsp">Lista de Pagos</a></li>
                            <li class="breadcrumb-item active">Detalle PAGO</li>
                        </ol>
                    </div>
                    <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% Modelo.PAGO a = Modelo.PAGO.getIdPago(ca);%>
                                    ...
                                    <form class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">COD PAGO:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getIdpago()); %> </p>
                                                        </div>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">FECHA PAGO:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getFechapago()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                           ...
                                           <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getMonto()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                           <%-- <button type="submit" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaGrado.jsp?codi=<%= a.getIdgrado()%>"> Editar</a></button> --%>
                                                         <%--   <button type="submit" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarApoderado?codi=<%= a.getIdgrado()%>"> Eliminar</a></button> --%>
