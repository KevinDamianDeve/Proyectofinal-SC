        ...
        <div class="page-wrapper">
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                               <h4 class="card-title">Selecciona Alumno para ver Reuniones</h4>
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link"  href="Reuniones2.jsp?codal=<%= t.getValueAt(i, 0)%> "    ><%= t.getValueAt(i, 1)%></a></td>
