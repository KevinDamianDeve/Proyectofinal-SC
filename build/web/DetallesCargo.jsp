<%-- 
    Document   : DetallesCargo
    Created on : 11-dic-2019, 6:05:08
    Author     : Jeampier
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detalle Cargos</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                            <li class="breadcrumb-item"><a href="ListaCargo.jsp">Lista de Cargos</a></li>
                            <li class="breadcrumb-item active">Detalle Cargos</li>
                        </ol>
                    </div>
                    <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% Modelo.CARGO a = Modelo.CARGO.getIdCargo(ca);%>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaCargo.jsp?codi=<%= a.getIdcargo()%>"> Editar</a></button>
                                                            <button type="button" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarCargo?codi=<%= a.getIdcargo()%>"> Eliminar</a></button>
