<%-- 
    Document   : ListaEstudiantesNoMatriculados
    Created on : 11-dic-2019, 5:47:59
    Author     : Jeampier
--%>
                                    ...
                                    <!--<tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesAlumno.jsp?cod=<%= a.getIdalumno()%>"><%= a.getNom()%> <%= a.getApellidos()%></a></td>
