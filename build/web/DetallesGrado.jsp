                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="ListaGrado.jsp">Lista de Grados</a></li>
                            <li class="breadcrumb-item active">Detalle GRADO</li>
                        </ol>
                    </div>
                    <div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <% Modelo.GRADO a = Modelo.GRADO.getIdGRado(ca);%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">GRADO Y SECCION:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getGradoseccion()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getMaxalumnos()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                        ...
                                                        <div class="row" >
                                                              <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">EN CURSO:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(a.getTotal()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                        </div>             
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaGrado.jsp?codi=<%= a.getIdgrado()%>"> Editar</a></button>
                                                            <button type="button"  class="btn btn-inverse" onclick="window.location.href='ListaGrado.jsp'">Cancelar</button>
                                                            <button type="button" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarGrado?codi=<%= a.getIdgrado()%>"> Eliminar</a></button>
