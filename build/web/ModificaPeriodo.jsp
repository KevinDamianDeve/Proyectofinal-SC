        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Actualizar Periodo</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Actualizar Periodo</h4>
                            </div>
                            <% String ca = request.getParameter("codi");%>
                                 <% Modelo.PERIODO a = Modelo.PERIODO.getIdPeriodo(ca);%>
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaPeriodo" >
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIdperiodo()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">PERIODO:<span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="per" value="<% out.println(a.getPeriodo()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-danger" name="esta" value="<% out.println(a.getEstado()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
