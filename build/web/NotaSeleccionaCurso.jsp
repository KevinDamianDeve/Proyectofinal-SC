<%-- 
    Document   : NotaSeleccionaCurso
    Created on : 27-dic-2019, 19:20:26
    Author     : Kevin Damian
--%>
...
<html lang="en">
    ...
    <% 
         int coda=Integer.parseInt(request.getParameter("cod"));
         ...
         <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
              ...
              <tbody>
                                        <%
                                            ...
                                            t = v.ListaCursosdeAlumno(codgrado, coda, cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                        <tr>
                                            <td><%= t.getValueAt(i, 0) %></td>
                                           <td><%= t.getValueAt(i, 1) %></td>
                                       <td class="title"><a class="link" href="NuevaNota.jsp?codalumno=<%= coda%>&codcurso=<%=t.getValueAt(i, 1) %>  "><%= t.getValueAt(i, 2) %></a></td>
