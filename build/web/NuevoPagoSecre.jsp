<%-- 
    Document   : NuevoPagoSecre
    Created on : 06-ene-2020, 23:08:10
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Nuevo Pago</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post" action="ServletRegistrarPagoSecre" class="form-horizontal">
                                    <div class="form-body">
                                       ...
                                       <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="alumno" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.ALUMNO cat : Modelo.ALUMNO.ListaAlumnoNoMatriculados()) {%>

                                                            <option value="<%=cat.getIdalumno()%>" > <%=cat.getNom() + " " + cat.getApellidos()%></option>
                                                            <% }%>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">PAGO <span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="number" class="form-control form-control-danger" name="pago" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
