<%-- 
    Document   : ListaPadresSecre
    Created on : 28-dic-2019, 23:29:22
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Padres</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="IndexSecre.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Padres</li>
                    </ol>
                </div>
                <div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Apoderados Activos Actualmente.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">DNI</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">Fecha Nacimiento</th>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Parentesco</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                            Apoderado v = new Apoderado();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaApoderados(cn.conectar());
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.Apoderado a:Apoderado.ListaApoderado()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesApoderadoSecre.jsp?cod=<%= a.getIdApoderado()%>"><%= a.getNombre()%> <%= a.getApellidos()%></a></td>
                                                 <td><%= a.getDni()%></td>
                                                 <td><%= a.getFechanacimiento()%></td>
                                                 <td><%= a.getGenero()%></td>
                                                 <td><%= a.getCelular()%></td>
                                                 <td><%= a.getParentesco()%></td>
                                             </tr>
                                             <% }%>
                                         </tbody>
                                </table>
