 ...
 * @author Kevin Damian
 */
@WebServlet(name = "ServletRegistrarReunion", urlPatterns = {"/ServletRegistrarReunion"})
@MultipartConfig
public class ServletRegistrarReunion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletRegistrarReunion</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletRegistrarReunion at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       r.setIdgrado(grado);
        ...
        if (REUNIONES.RegistraReunion(r)) {
            
          request.setAttribute("mensaje","LA REUNION SE INGRESO DE MANERA CORRECTA");
        }else{
            request.setAttribute("mensaje","ERROR LA REUNION NO SE INGRESO");
        }
