 ...
 * @author Kevin Damian
 */
@WebServlet(name = "ServletRegistrarApoderadoSecre", urlPatterns = {"/ServletRegistrarApoderadoSecre"})
@MultipartConfig
public class ServletRegistrarApoderadoSecre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletRegistrarApoderadoSecre</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletRegistrarApoderadoSecre at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
