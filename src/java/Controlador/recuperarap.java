 ...
 * @author Richard
 */
@WebServlet(name = "recuperarap", urlPatterns = {"/recuperarap"})
public class recuperarap extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          request.setAttribute("mensaje","Envio Correctamente, Revise su correo");
           ...
           request.getRequestDispatcher("RecuperarContraseñaPadre.jsp").forward(request, response);
    ...
    public static boolean enviarcorreo(String correo, String dni) {
        ...
        try {
            ...
            String consulta = "SELECT nombre, apellidos, email, clave FROM apoderado WHERE email=? AND dni =?";//Prevenir el sqlInyector
