 ...
 * @author Kevin Damian
 */
@WebServlet(name = "ServletModificaAlumnoSecre", urlPatterns = {"/ServletModificaAlumnoSecre"})
@MultipartConfig
public class ServletModificaAlumnoSecre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletModificaAlumnoSecre</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletModificaAlumnoSecre at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
