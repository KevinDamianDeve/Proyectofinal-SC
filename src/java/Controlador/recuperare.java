 ...
 * @author Richard
 */
@WebServlet(name = "recuperare", urlPatterns = {"/recuperare"})
public class recuperare extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          request.setAttribute("mensaje","Envio Correctamente, Revise su correo");
           ...
           request.getRequestDispatcher("RecuperarContraseñaAlumno.jsp").forward(request, response);
    ...
    public static boolean enviarcorreo(String correo, String dni) {
        ...
        try {
            ...
            String consulta = "SELECT nombre, apellidos, email, contraseña FROM alumno WHERE email=? AND dni =?";//Prevenir el sqlInyector
