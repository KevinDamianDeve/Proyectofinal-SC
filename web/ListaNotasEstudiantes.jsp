        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Notas</h3>
                </div>
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">COD GRADO</th>
                                        ...
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">COD CURDO</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">CURSO</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">NOTA</th>                                     
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">OBSERVACION</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">TRIMESTRE</th>
                                        
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            int idcu=Integer.parseInt(request.getParameter("codc"));
                                            NOTAS v = new NOTAS();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaNotasporCurso(car.getIdalumno(),idcu, cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link"><%= t.getValueAt(i, 5)%></a></td>
                                            <td class="title"><a class="link"><%= t.getValueAt(i, 6)%></a></td>
                                            <td class="title"><a class="link"><%= t.getValueAt(i, 7)%></a></td>
