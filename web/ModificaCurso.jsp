        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Actualizar Curso</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaCurso" >
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIdcurso()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">CURSO:<span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="car" value="<% out.println(a.getNombrecurso()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <button type="button"  class="btn btn-inverse" onclick="window.location.href='ListaCurso.jsp'">Cancelar</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6"> 
