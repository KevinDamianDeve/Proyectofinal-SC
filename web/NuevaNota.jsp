<%-- 
    Document   : NuevaNota
    Created on : 26-dic-2019, 23:56:29
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Nueva Nota</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Nuevo Nota</li>
                    </ol>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <%
                               int coda=Integer.parseInt(request.getParameter("codalumno"));
                            int codcurso=Integer.parseInt(request.getParameter("codcurso"));
                            %>
                            <div class="card-body">
                                <form method="post"  action="ServletRegitrarNota"  class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                       <div class="col-md-9">
                                                           <input type="text" name="alumno" value="<%=coda%>" class="form-control form-control-danger" readonly>
                                                    </div>
                                         ...
                                         <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                     <div class="col-md-9">
                                                           <input type="text" name="curso" value="<%=codcurso%>" class="form-control form-control-danger" readonly>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="trimestre" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.TRIMESTRE cat : Modelo.TRIMESTRE.ListaTrimestre()) {%>

                                                            <option value="<%=cat.getIdtrimestre()%>" > <%=cat.getDes()%></option>
                                                            <% }%>
                                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="nota" class="form-control form-control-danger" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="m-b-10">
                                                            <input type="text" name="obs" id="input-file-now" class="form-control form-control-danger"  required="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
