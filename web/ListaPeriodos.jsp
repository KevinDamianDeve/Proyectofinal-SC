<%-- 
    ...
    Created on : 11-dic-2019, 11:24:36
    Author     : Jeampier
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Periodos</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Periodos</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Lista de Periodos</h4>
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Periodos  .</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">ESTADO</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                            PERIODO v = new PERIODO();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListapERIODO(cn.conectar());
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.PERIODO a : PERIODO.ListaPeriod()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesPeriodo.jsp?cod=<%= a.getIdperiodo()%>"><%= a.getPeriodo()%></a></td>
