<%-- 
    Document   : loginprofe
    Created on : 07-ene-2020, 11:05:54
    Author     : Kevin Damian
--%>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(assets/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                ...
                <form role="form" class="form-horizontal" action="SERVLOGINDOCENTE" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="embed-responsive embed-responsive-4by3">
                                <iframe class="embed-responsive-item" src="RecuperarContraseñaDocente.jsp"></iframe>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info btm-sm" data-dismiss="modal" onclick= "self.location.href = 'loginpadre.jsp'">
                                CANCELAR</button>
