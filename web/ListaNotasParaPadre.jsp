        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <h3 class="text-themecolor">Grado y Cursos de <%=nombrea %>  </h3>
                </div>
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            t = v.ListaCursosdelalumno(idalumno, cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link"  href="ListaNotasEstudiantesParaPadre.jsp?codc=<%= t.getValueAt(i, 1)%>&coda=<%=idalumno%> "    ><%= t.getValueAt(i, 2)%></a></td>
