            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="ListaUsuarios.jsp">Lista de Usuarios</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <% String ca = request.getParameter("codi");%>
                                 <% Modelo.USUARIO a = Modelo.USUARIO.getIdUsuarioid(ca);%>
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaUsuario" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIdusuario()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Nombres <span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="nom" value="<% out.println(a.getNombres()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="fec" value="<% out.println(a.getFnacimiento()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="cel" class="form-control" value="<% out.println(a.getCelular()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                                    <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="tel" class="form-control" value="<% out.println(a.getTelefono()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="cargo" value="<% out.println(a.getIdcargo()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
