            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Grado y Curso</li>
                    </ol>
                </div>
                <div>
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                          ...
                                          <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">GRADO</th>
                                           <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">CURSO</th>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">PERIODO</th>                                            
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">OBSERVACION</th>
                                               <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">DOCENTE</th>

                                        </tr>
                                    </thead>
                                   <tbody>
                                       <%   int codc=Integer.parseInt(request.getParameter("codcu")); %>
                                        <%
                                            
                                            NOTAS v = new NOTAS();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();                                      
                                            t = v.ListaNotasAlumnoProfesorx2(car.getIddodocente(),codc, cn.conectar());
