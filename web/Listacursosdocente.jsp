<%-- 
    Document   : Listacursosdocente
    Created on : 22-dic-2019, 22:39:06
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Cursos del Docente</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Cursos del Docente</li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cursos del Docente</h4>
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Cursos del Docente..</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">CURSO</th>
                                         ...
                                         <tbody>
                                             <% for(Modelo.CURSO_DOCENTE a : Modelo.CURSO_DOCENTE.ListaCargoDocente() ) { %>
                                             <tr>
                                                
                                                 <td class="title"><a class="link" href="DetallesCursoDocente.jsp?cod=<%= a.getIdcursodocente()%>"><%= a.getDescurso()%></a></td>
                                             
                                                 <td><%= a.getDesdocente()%></td>
                                                <td><%= a.getDesgrado()%></td>
                                             </tr>
                                             <% }%>
                                         </tbody>
