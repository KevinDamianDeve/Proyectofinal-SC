            ...
            <div class="container-fluid">
               ...
               <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona un grado para registrar reunion</h4>
                                 <tr>
                                    <td colspan="2">
                                        <h3><font color="red">
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="NuevaReunionCurso.jsp?codgra=<%= t.getValueAt(i, 0)%>"><%= t.getValueAt(i, 1)%></a></td>
