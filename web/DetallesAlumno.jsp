<%-- 
    ...
    Created on : 11-dic-2019, 2:33:00
    Author     : Jeampier
--%>
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="ListaEstudiantes.jsp">Lista de Estudiantes</a></li>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn btn-info"> <i class="fa fa-pencil"></i><a class="link" href="ModificaAlumno.jsp?codi=<%= a.getIdalumno()%>"> Editar</a></button>
                                                            <button type="button" class="btn btn-danger"> <i class="fa fa-pencil"></i><a class="link" href="ServleteliminarAlumno?codi=<%= a.getIdalumno()%>"> Eliminar</a></button>
