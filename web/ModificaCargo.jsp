<%-- 
    Document   : ModificaCargo
    Created on : 11-dic-2019, 6:08:26
    Author     : Jeampier
--%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaCargo" >
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           ...
                                           class="form-control"
                                           value="<% out.println(a.getIdcargo()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">CARGO:<span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="car" value="<% out.println(a.getDescripcion()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
