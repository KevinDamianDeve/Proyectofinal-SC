<%-- 
    Document   : Profesores
    Created on : 08-ene-2020, 17:31:39
    Author     : Kevin Damian
--%>
...
%>
<%
Modelo.ALUMNO car = new Modelo.ALUMNO();
        try {
            Connection con = Modelo.Conexion.conectar();
            PreparedStatement ps = con.prepareStatement(" SELECT idalumno, nombre, apellidos, email, foto FROM alumno WHERE usuario=? AND contraseña =?");
            ps.setString(1, usu);
        ...
        %>
         ...
         <% int coddo = Integer.parseInt(request.getParameter("codd"));
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                ca.setIddodocente(rs.getInt(1));
                ca.setFoto(rs.getString(2));
                ca.setDni(rs.getInt(3));
                ca.setNombres(rs.getString(4));
                ca.setApellidos(rs.getString(5));
                ca.setDireccion(rs.getString(6));
                ca.setTelefono_fijo(rs.getString(7));
                ca.setCelular(rs.getString(8));
                ca.setFecha_n(rs.getString(9));
                ca.setCorreo(rs.getString(10));
                ca.setTitulo(rs.getString(11));
                ca.setEstado(rs.getString(12));
                ca.setDiaReg(rs.getString(13));
                ca.setUsuario(rs.getString(14));
                ca.setContra(rs.getString(15));
                con.close();
    ...
    <div id="main-wrapper">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href=""><i class="ti-user"></i> <%=car.getNom()%> <%=car.getApellidos()%>  </a></li>
                                    <li><a href=""><i class="ti-email"></i> <%=car.getEmail() %></a></li>
                                    <li role="separator" class="divider"></li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="SERVLOGINALUMNO?cerrar=true"><i class="fa fa-power-off"></i> Salir</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <%@include file="navegacionAlumno.jsp" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="IndexAlumno">Inicio</a></li>
                            ...
                            <div class="card card-outline-info">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <h3 class="box-title">INFORMACION DEL DOCENTE</h3>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(ca.getNombres()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(ca.getApellidos()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <img width="200"  height="200" src="<% out.println(ca.getFoto()); %>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <% out.println(ca.getCorreo()); %> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
