        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Nuevo Curso del Docente</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Nuevo Curso Del Docente</li>
                    </ol>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletRegistrarCursoDocente" class="form-horizontal">
                                    <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="curso" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.CURSO cat : Modelo.CURSO.ListaCargo()) {%>

                                                            <option value="<%=cat.getIdcurso()%>" > <%=cat.getNombrecurso()%></option>
                                                            <% }%>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="docente" class="form-control"required>
                                                            <option></option>
                                                            <% for (Modelo.DOCENTE cat : Modelo.DOCENTE.ListaDocente()) {%>

                                                            <option value="<%=cat.getIddodocente()%>" > <%=cat.getNombres()+ " " + cat.getApellidos()%></option>
                                                            <% }%>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select  name="grado" class="form-control"required>
                                                            ...
                                                            <option value="<%=cat.getIdgrado()%>" > <%=cat.getGradoseccion()%></option>
                                                            <% }%>
                                                        </select>
