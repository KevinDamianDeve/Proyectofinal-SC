<%-- 
    Document   : ListaEstudiantesSecre
    Created on : 02-ene-2020, 13:04:01
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Alumnos</h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Alumnos Activos Actualmente.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <!--<tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.ALUMNO a:ALUMNO.ListaAlumno()) { %>
                                             <tr>
