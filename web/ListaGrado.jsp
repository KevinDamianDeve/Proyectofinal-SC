<%-- 
    Document   : ListaGrado
    Created on : 11-dic-2019, 4:47:42
    Author     : Jeampier
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Grados</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Lista de Grados</li>
                    </ol>
                </div>
                <div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Grados Activos Actualmente.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">MAX ALUMNOS</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.GRADO a:GRADO.ListaGrado()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesGrado.jsp?cod=<%= a.getIdgrado()%>"><%= a.getGradoseccion()%></a></td>
                                             
                                                 <td><%= a.getMaxalumnos()%></td>
                                             </tr>
                                             <% }%>
                                         </tbody>
                                </table>
