<%-- 
    Document   : ListaPagosSecre
    Created on : 06-ene-2020, 22:56:37
    Author     : Kevin Damian
--%>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Pagos Activos Actualmente.</h6>
                                    ...
                                    <!--<tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesPagoSecre.jsp?cod=<%= a.getIdpago()%>"><%= a.getFechapago()%></a></td>
                                             <td><%= a.getNombre()%></td>
                                                 <td><%= a.getMonto()%></td>
                                             </tr>
                                             <% }%>
