<%-- 
    Document   : ListaCargo
    Created on : 11-dic-2019, 5:58:27
    Author     : Jeampier
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Cargos</h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Cargos Activos Actualmente.</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                        <tr>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist"> CARGO</th>
                                    ...
                                    <!--<tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tbody>
                                             <% for(Modelo.CARGO a : CARGO.ListaCargo()) { %>
                                             <tr>
                                                 <td class="title"><a class="link" href="DetallesCargo.jsp?cod=<%= a.getIdcargo()%>"><%= a.getDescripcion()%></a></td>
