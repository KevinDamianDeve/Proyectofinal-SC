<%-- 
    Document   : ListaMatriculasSecre
    Created on : 06-ene-2020, 23:28:01
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Matriculas</h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Se Muestra la Lista de Todos Los Matriculas  .</h6>
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                         <tr>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist"># MATRICULA</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">Fecha Matricula</th>
                                 <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">Fecha Pago</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0"># Alumno</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">ALUMNO</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Periodo</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Usuario</th>
                                        </tr>
                                    </thead>
                                    <!--<tbody>
                                        <%
                                            MATRICULA v = new MATRICULA();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaumATRICULAS(cn.conectar());
                                        ...
                                        <tr>
                                            <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 0) %></a></td>
                                             ...
                                             <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 2) %></a></td>
                                                <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 3) %></a></td>
                                             <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 4) %></a></td>
                                             <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 5) %></a></td>
                                             <td class="title"><a class="link" href="javascript:void(0)"><%= t.getValueAt(i, 6) %></a></td>
                                        </tr>  
                                         <% } %>                                           
                                    </tbody>-->
                                         <tbody>
                                             <% for(Modelo.MATRICULA a : MATRICULA.ListaMatricula()) { %>
                                             <tr>
                                             <td><%= a.getIdmatricula()%></a></td>
                                             <td><%= a.getFechamatricula()%></td>
                                                 <td><%= a.getNombrepago()%></td>
                                                  <td><%= a.getIdalumno()%></td>
                                                   <td><%= a.getNomalumno()%></td>
                                                    <td><%= a.getNomperiodo()%></td>
                                                     <td><%= a.getNomusuario()%></td>
                                             </tr>
                                             <% }%>
                                         </tbody>
                                </table>
