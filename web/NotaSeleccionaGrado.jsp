<%-- 
    Document   : NotaSeleccionaGrado
    Created on : 27-dic-2019, 18:06:56
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Selecciona Grado</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Selecciona Grado</li>
                    </ol>
                </div>
                <div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                   ...
                                   <tbody>
                                             ...
                                             <tr>
                                                 <td class="title"><a class="link" href="NotaSeleccionaAlumno.jsp?cod=<%= a.getIdgrado()%>"><%= a.getGradoseccion()%></a></td>                                             
                                             </tr>
                                             <% }%>
                                         </tbody>
