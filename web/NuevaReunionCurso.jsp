<%-- 
    Document   : NuevaReunion
    Created on : 08-ene-2020, 13:25:06
    Author     : Kevin Damian
--%>
     ...
     <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Nueva Reunion</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="IndexProfe.jsp">Inicio</a></li>
                        <!--<li class="breadcrumb-item">pages</li>-->
                        <li class="breadcrumb-item active">Nueva Reunion</li>
                    </ol>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method="post"  action="ServletRegistrarReunion" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                           <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                       <div class="col-md-9">
                                                           <input type="text" name="docente" value="<%=car.getIddodocente() %>" class="form-control form-control-danger" readonly>
                                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="col-md-9">
                                            <input type="text" name="grado" value="<%=codgrado%>" class="form-control form-control-danger" readonly>
                                        </div>
