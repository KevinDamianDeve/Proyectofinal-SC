        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Grados y Cursos que  llevas </h3>
                </div>
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona Curso para ver notas</h4>
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                       cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">GRADO Y SECCION</th>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            t = v.ListaCursosdelalumno(car.getIdalumno(), cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="ListaNotasEstudiantes.jsp?codc=<%= t.getValueAt(i, 1)%> "><%= t.getValueAt(i, 2)%></a></td>
