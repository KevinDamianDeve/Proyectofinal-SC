        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <h4 class="text-themecolor"> Docente: <%=car.getNombres() %> <%=car.getApellidos()%>  </h4>
                </div>
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona Grado Para Registrar Nota</h4>
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="ListaEstudiantesProfe.jsp?cod=<%= t.getValueAt(i, 0)%>&gra=<%= t.getValueAt(i, 1)%> "><%= t.getValueAt(i, 1)%></a></td>
