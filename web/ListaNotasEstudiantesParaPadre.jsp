        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">LISTADO DE NOTAS </h3>
                </div>
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <thead>
                                       ...
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">ALUMNO</th>
                                        ...
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">TRIMESTRE</th>
                                         <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">PERIODO</th>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            int ida=Integer.parseInt(request.getParameter("coda"));
                                            NOTAS v = new NOTAS();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.ListaNotasporCurso(ida, idcu, cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link"><%= t.getValueAt(i, 8)%></a></td>
