        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Actualizar Notas</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="Index.jsp">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="Listanotas.jsp">Lista de Notas</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <% String ca = request.getParameter("codi");%>
                                 <% Modelo.NOTAS a = Modelo.NOTAS.getIdNotasModificado(ca);%>
                            <div class="card-body">
                                <form method="post"  action="ServletmodificaNota" >
                                    <div class="form-body">
                                        <h3 class="box-title">Información </h3>
                                        <hr class="m-t-0 m-b-40">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input  hidden type="text" name="co" class="form-control" value="<% out.println(a.getIdnotas()); %>" readonly>
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">COD: ALUMNO <span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="al" value="<% out.println(a.getIdalumno()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3"> COD CURSO: <span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-danger" name="cur" value="<% out.println(a.getIdcurso()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">                                               
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">COD: TRIMESTRE <span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="tr" value="<% out.println(a.getIdtrimestre()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">NOTA: <span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-danger" name="no" value="<% out.println(a.getNota()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row" >
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">OBSERVACION: <span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form-control-danger" name="ob" value="<% out.println(a.getObservacion()); %>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <button type="button"  class="btn btn-inverse" onclick="window.location.href='Listanotas.jsp'">Cancelar</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6"> 
