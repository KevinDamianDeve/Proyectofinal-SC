        ...
        <div class="page-wrapper">
           ...
           <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona descripcion de reunion para mas detalles</h4>
                                                                <tr>
                                    <td colspan="2">
                                        <h3><font color="red">
                                    ...
                                    <thead>
                                      ...
                                      <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">DOCENTE</th>
                                       <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">GRADO Y SECCION</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">FECHA DE REGISTRO</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">DESCRIPCION DE REUNION</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">ARCHIVO</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                            REUNIONES v = new REUNIONES();
                                            Conexion cn = new Conexion();
                                            DefaultTableModel t = new DefaultTableModel();

                                            t = v.REUNIOESPORDOCENTE( car.getIddodocente() ,   cn.conectar());
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link"   ><%= t.getValueAt(i, 2) %></a></td>
                                             ...
                                             <td class="title"><a class="link" href="DetalleReunion.jsp?codre=<%= t.getValueAt(i, 0) %>"><%= t.getValueAt(i, 5) %></a></td>
                                             <td class="title"><a class="link"  href="<%= t.getValueAt(i, 6)%>" target="_blank"><%= t.getValueAt(i, 6) %></a></td>
                                        </tr>  
                                         <% } %>                                           
                                    </tbody>
              </table>
