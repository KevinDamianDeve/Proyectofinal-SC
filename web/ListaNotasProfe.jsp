<%-- 
    Document   : ListaNotasProfe
    Created on : 07-ene-2020, 16:36:45
    Author     : Kevin Damian
--%>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Lista de Grados y Cursos  que enseñas</h3>
                </div>
            ...
            <div class="container-fluid">
               ...
               <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Selecciona un grado para ver los alumnos</h4>
                                 <tr>
                                    <td colspan="2">
                                        <h3><font color="red">
                  ...
                  <table id="example23" class="display nowrap table table-hover table-striped table-bordered" 
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            t = v.ListaCursosdelDocente( car.getIddodocente(), cn.conectar());
                                            for (int i = 0; i < t.getRowCount(); i++) {
                                        %>
                                
                                        <tr>
                                            <td class="title"><a class="link" ><%= t.getValueAt(i, 0)%></a></td>
                                            <td class="title"><a class="link" href="ListaNotasAlumnosProfe.jsp?codcu=<%= t.getValueAt(i, 2)%>"><%= t.getValueAt(i, 1)%></a></td>
